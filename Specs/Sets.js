var Sets = {
	...
	'1.2private': {
		dir : '../assets/core/Specs/',
		files : ['Core/Core.js', 'Core/Browser.js']
	},
	
	'1.1public': {
		dir : './',
		files : ['Core/Browser.js','Class/Class.js','Native/Array.js','Native/Function.js',
			'Native/Hash.js','Element/Element.js']
	}
